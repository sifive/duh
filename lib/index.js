...
exports.generate = async argv => {
    ...
    await outputFile('build/duh.json5', JSON5.stringify(duh, null, 2));
    // generate expanded IP-XACT
    // TODO
    // generate Scala wrapper
    await outputFile('build/duh.scala', genScala(duh));
    // generate verilog black box
    await outputFile('build/duh-bbx.v', genVerilogBBX(duh));
};
